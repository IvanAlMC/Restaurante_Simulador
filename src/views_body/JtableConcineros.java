...
public class JtableConcineros extends JPanel{
	...
	public JtableConcineros(ActionListener actionListenner) {
		jPanel = new Panel();
		jPanel.setBackground(new Color(0,0,32));
		add(jPanel);
		initComponents(); 
	}
	...
	public void changeLanguageColunmJtable(){
		String[] headers = {"N","COCINERO","ESTADO"};
	...
	public void stringFormat(ArrayList<Object[]> info) {
		...
		for (Object[] objects : info) {
			int i = 0;
			arrayFormat.add(new Object[] {objects[i],objects[++i],objects[++i]});
		}
